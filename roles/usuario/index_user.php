...
<body style="font-family: 'Noto Sans', sans-serif;">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<!-- <img src="/assets/img/logoCars.png" alt="Logo" width="300"> -->
						<h1><font color="#E6E6FA", face="Brush Script MT, cursive">Car'sRental.com</font> </h1>
					</ul>
	...
	<main>
		<section>
			<img src="../../assets/img/homeinicio.png" class="img-fluid" alt="Portada">
		</section>

		<article class="text-center">
			<br><br>
		<h1><font color="#800080", face="Comic Sans MS,arial,verdana">Stock de vehiculos</font> </h1>
		...
		<section class="py-5 container">
			<article class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
               ...
               <span class="fw-bold fs-5 text-danger"> $30.00 </span>
               ...
               <a class="btn btn-outline-danger" href="../../catalogo/sentra.html" title="Detalles"> Ver detalles </a>
                ...
                <span class="fw-bold fs-5 text-danger"> $35.00 </span>
                <p class="card-text bi-star"> (6 Reviews). </p>
                ...
                <span class="fw-bold fs-5 text-danger"> $25.00 </span>
                <p class="card-text bi-star"> (6 Reviews). </p>
                ...
                <span class="fw-bold fs-5 text-danger"> $85.00 </span>
                <p class="card-text bi-star"> (6 Reviews). </p>
                ...
                <a class="btn btn-outline-danger" href="../../catalogo/lancer.html" title="Detalles"> Ver detalles </a>
					...
					<div class="col">
						<div class="card shadow-sm">
							<img src="../../assets/img/proxi.jpeg" alt="IMG_12" class="img-fluid">
							<div class="card-body">
								<h3> - </h3>
                <span> - </span>
                <p class="card-text bi-star"> Proximamente Nuevos vehiculos . </p>
							</div>
						</div>
					</div>
				</div>
